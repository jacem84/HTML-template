...
function Image_Crop($image, $x, $y, $w, $h) // Recipe 15 - Renamed from ImageCrop()
                                            // due to PHP 5 now having such a function.
{
...
function CreateCaptcha($size, $length, $font, $folder, $salt1, $salt2) // Recipe 33
{
   ...
   GifText($fname, $captcha, $font, $size, "444444",
